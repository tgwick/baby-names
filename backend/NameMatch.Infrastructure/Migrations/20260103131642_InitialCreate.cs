        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameText = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartnerLink = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Names_Gender",
                table: "Names",
                column: "Gender");

            migrationBuilder.CreateIndex(
                name: "IX_Names_NameText",
                table: "Names",
                column: "NameText");

            migrationBuilder.CreateIndex(
                name: "IX_Sessions_InitiatorId",
                table: "Sessions",
                column: "InitiatorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_PartnerId",
                table: "Sessions",
                column: "PartnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Sessions_PartnerLink",
                table: "Sessions",
                column: "PartnerLink",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Votes_NameId",
                table: "Votes",
                column: "NameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_UserId_NameId_SessionId",
                table: "Votes",
                columns: new[] { "UserId", "NameId", "SessionId" },
                unique: true);
        }
